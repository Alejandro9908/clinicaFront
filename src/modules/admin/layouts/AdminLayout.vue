            ...
            <DialogPanel class="relative mr-16 flex w-full max-w-xs flex-1">
              ...
              <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6 pb-4 ring-1 ring-white/10">
                <div class="flex h-16 shrink-0 items-center">
                  <h1 class="text-white font-bold text-2xl">Clinica Salud Integral</h1>
                </div>
          ...
          <div class="flex items-center gap-x-4 lg:gap-x-6">
            ...
            <Menu as="div" class="relative">
              <MenuButton class="-m-1.5 flex items-center p-1.5">
                ...
                <span class="inline-flex size-8 items-center justify-center rounded-full bg-blue-500">
                  <span class="text-lg font-medium text-white">U</span>
                </span>
                <span class="hidden lg:flex lg:items-center">
                  <span class="ml-4 text-sm/6 font-semibold text-gray-900" aria-hidden="true">User</span>
